...
//  const response = await fetch('https://gateway-service-production-110685455967.asia-south1.run.app/user-resources/plan-details', {
//  headers: {
...
//  const token = localStorage.getItem('token');
//  const response = await fetch('https://gateway-service-production-110685455967.asia-south1.run.app/payments/history', {
//  headers: {
//  'Authorization': `Bearer ${token}`,
//  'Content-Type': 'application/json'
//  },
...
//  const token = localStorage.getItem('token');
//  const response = await fetch(`https://gateway-service-production-110685455967.asia-south1.run.app/files/user-usage-and-plan/${userId}`, {
//  headers: {
//  'Authorization': `Bearer ${token}`,
//  'Content-Type': 'application/json'
//  },
